...
PARAM_DEFS = {
    "apple_weight":       (0.0, 10.0, 3.8),
    "apple_dist_decay":   (0.01, 0.5, 0.20),
    "cluster_bonus":      (0.0, 2.0, 0.25),
    "safety_weight":      (1.0, 10.0, 7.0),
    "dead_end_penalty":   (2.0, 20.0, 11.0),
    "fall_penalty":       (1.0, 10.0, 6.0),
    "wall_penalty":       (0.2, 5.0, 1.4),
    "space_weight":       (0.0, 10.0, 3.6),
    "height_weight":      (0.0, 5.0, 0.7),
    "center_weight":      (0.0, 3.0, 0.2),
    "opponent_proximity": (0.5, 10.0, 4.2),
    "aggression":         (0.0, 5.0, 0.8),
    "survival_priority":  (1.0, 10.0, 6.0),
    "length_bonus":       (0.0, 3.0, 0.35),
    "body_block_bonus":   (0.0, 3.0, 1.1),
    "enemy_above_penalty": (0.2, 10.0, 3.5),
    "head_on_win_bonus":   (0.0, 10.0, 3.0),
    "head_on_lose_penalty": (0.5, 12.0, 5.0),
    "head_on_even_penalty": (0.0, 6.0, 1.2),
    "top_edge_penalty":    (0.0, 5.0, 1.2),
    "side_edge_penalty":   (0.0, 3.0, 0.4),
    "ladder_bonus":        (0.0, 6.0, 1.6),
}
